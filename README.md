...
Several design issues that would need to be changed in a re-design of this robot would include, but not be limited to the following:
  ...
  7. Flexible, 3D printable TPU was used to line the wheels, but due to low friction led to slippage and errors in odometry measurements.  A cast solution using 3D printed moulds and a small vacuum  chamber would be a better choice of material for wheel linings.
